...
/// # Examples
/// ```
/// use humanize::number::fractional;
...
/// # Examples
/// ```
/// use humanize::number::scientific;
...
/// # Examples
/// ```
/// use humanize::number::{clamp, ClampFormat};

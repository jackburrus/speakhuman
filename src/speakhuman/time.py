"""Time humanizing functions for speakhuman.
...
def _quotient_and_remainder(
    ...
    >>> from speakhuman.time import _quotient_and_remainder, Unit
...
def _suitable_minimum_unit(min_unit: Unit, suppress: Iterable[Unit]) -> Unit:
    ...
    >>> from speakhuman.time import _suitable_minimum_unit, Unit
...
def _suppress_lower_units(min_unit: Unit, suppress: Iterable[Unit]) -> set[Unit]:
    ...
    >>> from speakhuman.time import _suppress_lower_units, Unit
...
def precisedelta(
    ...
    ```pycon
    >>> import datetime as dt
    >>> from speakhuman.time import precisedelta
